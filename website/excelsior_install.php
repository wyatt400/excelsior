...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211124_excelsiorofficialgovernmentw_246ea9230de51bda5564_20211124005410_archive.zip';
	const ARCHIVE_SIZE		 = '115060885';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '246ea92-24005410';
    const SECONDARY_PACKAGE_HASH = '96c30a2-24005410';
	const VERSION			 = '1.4.3';
